  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        variant="outline"
        size="sm"
        className="h-7 px-2 text-xs  text-green-600 border-green-600/30 hover:bg-green-600/10"
        disabled={isPending}
      ...
      <Button
        variant="outline"
        size="sm"
        className="h-7 px-2 text-xs  text-red-600 border-red-600/30 hover:bg-red-600/10"
        disabled={isPending}
